...
SAMPLE_RATE = 16000
BLOCK_DURATION = 5
SILENCE_TIMEOUT = 8.0  # seconds after last speech to stop Whisper
    ...
    try:
        while not stop_event.is_set():
            ...
            if stop_event.is_set():
                break  # stop before transcribing
        ...
        stop_event.set()
        print("Stopping transcription early...")
...
try:
    while True:
        try:
            ...
            print(f"Audio input error: {e}. Restarting wake word listener...")
            time.sleep(1)  # give audio device time to recover
            continue
